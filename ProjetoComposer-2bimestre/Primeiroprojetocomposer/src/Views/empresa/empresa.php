...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Empresas</h1>
        <a href="/empresa/inserir" class="btn btn-primary">Nova Empresa</a>
        <p><?= $mensagem ?></p>
        <table class="table table-stripped table-hover" id="tabela">
            ...
            <tbody>
                <?php
                    while($e = $resultado->fetch(PDO::FETCH_ASSOC)){
                    ?>
                        <tr>
                            ...
                            <td><?= $e['receita'] ?></td>
                            <td>
                                <a href="/empresa/alterar/id/<?= $e["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/empresa/excluir/id/<?= $e["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
