...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Produtos</h1>
        <a href="/produto/inserir" class="btn btn-primary">Novo Produto</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="/produto/alterar/id/<?= $p["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/produto/excluir/id/<?= $p["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
