...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Carros</h1>
        <a href="/carro/inserir" class="btn btn-primary">Novo Carro</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['ano'] ?></td>
                            <td>
                                <a href="/carro/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/carro/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
